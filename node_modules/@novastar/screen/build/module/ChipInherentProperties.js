...
const chipInfo = (ChipType, isCommon, hasGain, hasPointDetect, channelCount, gainSteps) => ({
    ChipType,
    isCommon,
    hasGain,
    hasPointDetect,
...
const gain16 = Array(16).map((_, index) => [
    16 * index,
    index >= 8 ? (56.25 + (index - 8) * 6.25) / 100 : (25 + 3.125 * index) / 100,
]);
const gain32 = Array(32).map((_, index) => [8 * index + 4, (index + 9) / 40]);
const gain64 = Array(64).map((_, index) => [
    4 * index + 2,
    index > 31 ? ((index - 32) * 3 + 33) / 65 : (index * 3 + 32) / 256,
]);
const gain384 = Array(384).map((_, index) => [
    index,
    index < 192 ? (index + 64) / 512 : (index - 128) / 256,
]);
const ChipInherentProperties = {
...
export const GetGainProportion = (gain) => {
    if (gain < 14)
        return (12.5 + 1.4 * gain) / 100;
    if (gain < 23)
        return (31.9 + 1.4 * (gain - 14)) / 100;
    if (gain < 32)
        return (44.4 + 1.4 * (gain - 23)) / 100;
    if (gain < 41)
        return (56.9 + 1.4 * (gain - 32)) / 100;
    if (gain < 50)
        return (69.4 + 1.4 * (gain - 41)) / 100;
    if (gain < 59)
        return (81.9 + 1.4 * (gain - 50)) / 100;
    return (94.4 + 1.4 * (gain - 59)) / 100;
};
export const IsPWMChip = (ChipType) => [
...
export const IsChangedOETableChip = (ChipType) => [
...
export const IsSupport = (ChipType) => [
...
export const IsSupportCurrentChipTypeEnum = (ChipType) => ChipType !== ChipTypeEnum.Chip_SUM6082 && ChipType !== ChipTypeEnum.Chip_NVS6867;
export const IsPWMAndHavePartNum = (ChipType) => [
    ChipTypeEnum.Chip_SUM2030,
    ChipTypeEnum.Chip_MY9268,
    ChipTypeEnum.Chip_SUM2130,
    ChipTypeEnum.Chip_MBI5030,
...
export const IsSupport5042GrayEnhanced = (ChipType) => [
    ChipTypeEnum.Chip_MBI5042,
    ChipTypeEnum.Chip_MBI5030,
    ChipTypeEnum.Chip_SM16136,
    ChipTypeEnum.Chip_MY9263,
...
export const IsSupportMBI5041BNewTiming = (ChipType) => [
    ChipTypeEnum.Chip_MBI5042B,
    ChipTypeEnum.Chip_SUM2028,
    ChipTypeEnum.Chip_MBIA043,
    ChipTypeEnum.Chip_MBI5043,
...
export const IsSupportDriverInterDeghostEnable = (ChipType) => [
    ChipTypeEnum.Chip_MBI5051,
    ChipTypeEnum.Chip_MBI5052,
    ChipTypeEnum.Chip_SM16158,
    ChipTypeEnum.Chip_SM16159,
...
export const IsSupportNewOERealizeWay = (ChipType) => ChipType === ChipTypeEnum.Chip_MBI5124New;
export const IsSupportPhotographMode = (ChipType) => [
    ChipTypeEnum.Chip_MY9868A,
    ChipTypeEnum.Chip_MY9862A,
    ChipTypeEnum.Chip_SM16207S,
    ChipTypeEnum.Chip_SM16237,
...
export const IsDoubleLatChip = (ChipType) => [
    ChipTypeEnum.Chip_MY9868A,
    ChipTypeEnum.Chip_MY9862A,
    ChipTypeEnum.Chip_SM16207S,
    ChipTypeEnum.Chip_SM16237,
...
export const IsConfigRegisterConcernWithScanType = (ChipType) => [
    ChipTypeEnum.Chip_MBI5050,
    ChipTypeEnum.Chip_SUM2030,
    ChipTypeEnum.Chip_SUM2130,
    ChipTypeEnum.Chip_MY9268,
...
export const IsConfigRegisterConcernWithShiftUnitNum = (ChipType) => [ChipTypeEnum.Chip_MBI6030, ChipTypeEnum.Chip_MBI6023].includes(ChipType);
export const GetDetectPointType = (ChipType) => {
    switch (ChipType) {
...
export const IsNoCurrentGainButConfig = (ChipType) => [
    ChipTypeEnum.Chip_SUM2017,
    ChipTypeEnum.Chip_SM16027,
    ChipTypeEnum.Chip_MBI5037,
    ChipTypeEnum.Chip_MY9221,
...
export const DetectPointIsConfigOtherReg = (ChipType) => [
    ChipTypeEnum.Chip_MBI5153,
    ChipTypeEnum.Chip_ICN2053,
    ChipTypeEnum.Chip_ICND2055,
    ChipTypeEnum.Chip_ICN2065,
...
export const CanManualAdjustRefreshRate = (chipType, scanType) => {
    switch (chipType) {
        case ChipTypeEnum.Chip_MBI5030:
        case ChipTypeEnum.Chip_MBI5040:
...
//# sourceMappingURL=ChipInherentProperties.js.map