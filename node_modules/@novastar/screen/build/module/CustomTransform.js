...
export const GetSmartMode = (isSmartMode, screenDriverType, chipType) => {
    if (!isSmartMode)
        return 0;
    if (chipType === ChipTypeEnum.Chip_MBI5359 || chipType === ChipTypeEnum.Chip_MBI5353)
        return 1;
    if (screenDriverType === ScreenDriveTypeEnum.Concurrent &&
...
export const IsSaveScreenCfgToHW = (cardType) => cardType === NSCardTypeEnum.NovaProHD ||
...
export const IsSystemController = (cardType) => cardType === NSCardTypeEnum.Controller ||
    cardType === NSCardTypeEnum.HDMICard ||
    ...
    cardType === NSCardTypeEnum.VX600 ||
    cardType === NSCardTypeEnum.VX400S;
export const GetPortNumber = (cardType) => {
    switch (cardType) {
