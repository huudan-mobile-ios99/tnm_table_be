...
const moduleStatusLow = {
    offset: AddressMapping.Scanner_RowLineRelatedInfoOfModuleStatusAddr -
...
const moduleStatusHigh = {
    offset: AddressMapping.Scanner_ModuleStatusOfMonitorCardAddr -
        AddressMapping.Scanner_AllMonitorDataAddr,
...
export const HWStatus = new Struct('HWStatus')
    ...
    .back(0)
    .seek(AddressMapping.Scanner_TempInfoOfMonitorCardAddr - AddressMapping.Scanner_AllMonitorDataAddr)
    .Struct('tempInfoInMonitorCard', TempInfo) // 39
    .Struct('humidityInfoInMonitorCard', ValueInfo) // 41
    .Struct('smokeWarnInfo', ValueInfo) // 42
    .StructArray('fanSpeedInfoListMonitorCard', FanSpeedInfo, AddressMapping.Scanner_FanSpeedOfMonitorCardNum) // 43
    .StructArray('valtageInfoListMonitorCard', VoltageInfo, AddressMapping.Scanner_VoltageOfMonitorCardNum) // 47
