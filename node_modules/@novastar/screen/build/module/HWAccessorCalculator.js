...
import { CaculateMaxloadSize, isValidScanBdProp, isValidStandardLedModuleProp, } from './CommonCalculator';
...
export const GetRateFromRateType = (rateType) => {
...
export const CheckIsModeSupport = (scanBdProperty, fieldRate) => {
    ...
    if (DriverChipType !== ChipTypeEnum.Chip_ICN2053)
    ...
    const { maxWidth, maxHeight } = CaculateMaxloadSize(result, scanBoardCapability.MaxLoadedPixels / k, MaxValue.MAX_SCANNER_AREA);
...
export const SetVariousScanBdRefreshRate = (scanBdProperty, isSmartMode) => {
...
export const GetAutoRefreshRateBytesSeq = (autoRateParamList) => {
