...
export declare const PointDetectConfig: t.IntersectionC<[t.TypeC<{
    ...
    DetectThreshold: t.Type<ThresholdTypeEnum, "None" | "Grade1" | "Grade2" | "Grade3" | "Grade4" | "Grade5" | "Grade6" | "Grade7" | "Grade8", unknown>;
    IsUseGain: t.Type<boolean, boolean, unknown>;
    DetectRedGainStep: t.Type<number, number, unknown>;
    DetectGreenGainStep: t.Type<number, number, unknown>;
    DetectBlueGainStep: t.Type<number, number, unknown>;
    IsSynchronousGain: t.Type<boolean, boolean, unknown>;
    IsUsedResistor: t.Type<boolean, boolean, unknown>;
    RedResistor: t.Type<number, number, unknown>;
    GreenResistor: t.Type<number, number, unknown>;
    BlueResistor: t.Type<number, number, unknown>;
}>, t.PartialC<{}>]>;
