...
export declare const ChipSM16388ExtendPropertyBase: t.IntersectionC<[t.PartialC<{}>, t.TypeC<{
 ...
 */
export declare const ChipSM16388ExtendProperty: t.IntersectionC<[t.IntersectionC<[t.PartialC<{}>, t.TypeC<{
    RegisterArray: t.ArrayC<t.Type<number, number, unknown>>;
}>, t.PartialC<{
    ShadowEliminationLevel_1: t.Type<number, number, unknown>;
    ShadowEliminationTime_1: t.Type<number, number, unknown>;
