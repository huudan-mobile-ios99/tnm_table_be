...
function createReadRedBrightness(addr, portAddr, scanBoardAddr) {
...
exports.default = createReadRedBrightness;
codec_1.Session.prototype.ReadRedBrightness = async function ReadRedBrightness(addr, portAddr, scanBoardAddr) {
...
codec_1.Session.prototype.tryReadRedBrightness = async function tryReadRedBrightness(addr, portAddr, scanBoardAddr) {
    const req = createReadRedBrightness(addr, portAddr, scanBoardAddr);
