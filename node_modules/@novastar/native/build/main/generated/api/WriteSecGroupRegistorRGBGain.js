...
function createWriteSecGroupRegistorRGBGain(addr, portAddr, scanBoardAddr, bBroadcast, data) {
...
exports.default = createWriteSecGroupRegistorRGBGain;
codec_1.Session.prototype.WriteSecGroupRegistorRGBGain = async function WriteSecGroupRegistorRGBGain(addr, portAddr, scanBoardAddr, bBroadcast, data) {
    const req = createWriteSecGroupRegistorRGBGain(addr, portAddr, scanBoardAddr, bBroadcast, data);
    await this.connection.send(req);
};
codec_1.Session.prototype.tryWriteSecGroupRegistorRGBGain = async function tryWriteSecGroupRegistorRGBGain(addr, portAddr, scanBoardAddr, data) {
