...
function createWriteSixthGroupRegistorGain(addr, portAddr, scanBoardAddr, bBroadcast, data) {
...
exports.default = createWriteSixthGroupRegistorGain;
codec_1.Session.prototype.WriteSixthGroupRegistorGain = async function WriteSixthGroupRegistorGain(addr, portAddr, scanBoardAddr, bBroadcast, data) {
    const req = createWriteSixthGroupRegistorGain(addr, portAddr, scanBoardAddr, bBroadcast, data);
    await this.connection.send(req);
};
codec_1.Session.prototype.tryWriteSixthGroupRegistorGain = async function tryWriteSixthGroupRegistorGain(addr, portAddr, scanBoardAddr, data) {
    const req = createWriteSixthGroupRegistorGain(addr, portAddr, scanBoardAddr, false, data);
    return (await this.connection.trySend(req))?.ack ?? null;
};
//# sourceMappingURL=WriteSixthGroupRegistorGain.js.map