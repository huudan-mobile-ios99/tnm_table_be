...
function createReadBgain(addr, portAddr, scanBoardAddr) {
...
exports.default = createReadBgain;
codec_1.Session.prototype.ReadBgain = async function ReadBgain(addr, portAddr, scanBoardAddr) {
    const req = createReadBgain(addr, portAddr, scanBoardAddr);
    return (0, codec_1.decodeUIntLE)(await this.connection.send(req));
};
codec_1.Session.prototype.tryReadBgain = async function tryReadBgain(addr, portAddr, scanBoardAddr) {
    const req = createReadBgain(addr, portAddr, scanBoardAddr);
    return this.connection.trySend(req);
};
//# sourceMappingURL=ReadBgain.js.map