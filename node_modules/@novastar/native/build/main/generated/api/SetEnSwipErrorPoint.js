...
function createSetEnSwipErrorPoint(addr, portAddr, scanBoardAddr, bBroadcast, data) {
...
exports.default = createSetEnSwipErrorPoint;
codec_1.Session.prototype.SetEnSwipErrorPoint = async function SetEnSwipErrorPoint(addr, portAddr, scanBoardAddr, bBroadcast, data) {
    const req = createSetEnSwipErrorPoint(addr, portAddr, scanBoardAddr, bBroadcast, data);
    await this.connection.send(req);
};
codec_1.Session.prototype.trySetEnSwipErrorPoint = async function trySetEnSwipErrorPoint(addr, portAddr, scanBoardAddr, data) {
    const req = createSetEnSwipErrorPoint(addr, portAddr, scanBoardAddr, false, data);
    return (await this.connection.trySend(req))?.ack ?? null;
};
//# sourceMappingURL=SetEnSwipErrorPoint.js.map