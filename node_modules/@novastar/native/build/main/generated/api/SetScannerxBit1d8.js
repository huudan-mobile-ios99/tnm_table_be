...
function createSetScannerxBit1d8(addr, portAddr, scanBoardAddr, bBroadcast, da) {
...
exports.default = createSetScannerxBit1d8;
codec_1.Session.prototype.SetScannerxBit1d8 = async function SetScannerxBit1d8(addr, portAddr, scanBoardAddr, bBroadcast, da) {
    const req = createSetScannerxBit1d8(addr, portAddr, scanBoardAddr, bBroadcast, da);
    await this.connection.send(req);
};
codec_1.Session.prototype.trySetScannerxBit1d8 = async function trySetScannerxBit1d8(addr, portAddr, scanBoardAddr, da) {
