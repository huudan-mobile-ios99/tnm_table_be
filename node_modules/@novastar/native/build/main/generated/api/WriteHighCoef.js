...
function createWriteHighCoef(addr, portAddr, scanBoardAddr, bBroadcast, data) {
...
exports.default = createWriteHighCoef;
codec_1.Session.prototype.WriteHighCoef = async function WriteHighCoef(addr, portAddr, scanBoardAddr, bBroadcast, data) {
    const req = createWriteHighCoef(addr, portAddr, scanBoardAddr, bBroadcast, data);
    await this.connection.send(req);
};
codec_1.Session.prototype.tryWriteHighCoef = async function tryWriteHighCoef(addr, portAddr, scanBoardAddr, data) {
