...
function createWriteFifthGroupRegistorGain(addr, portAddr, scanBoardAddr, bBroadcast, data) {
...
exports.default = createWriteFifthGroupRegistorGain;
codec_1.Session.prototype.WriteFifthGroupRegistorGain = async function WriteFifthGroupRegistorGain(addr, portAddr, scanBoardAddr, bBroadcast, data) {
    const req = createWriteFifthGroupRegistorGain(addr, portAddr, scanBoardAddr, bBroadcast, data);
    await this.connection.send(req);
};
codec_1.Session.prototype.tryWriteFifthGroupRegistorGain = async function tryWriteFifthGroupRegistorGain(addr, portAddr, scanBoardAddr, data) {
    const req = createWriteFifthGroupRegistorGain(addr, portAddr, scanBoardAddr, false, data);
    return (await this.connection.trySend(req))?.ack ?? null;
};
//# sourceMappingURL=WriteFifthGroupRegistorGain.js.map