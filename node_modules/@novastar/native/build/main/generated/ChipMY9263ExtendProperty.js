...
exports.ChipMY9263ExtendProperty = exports.ChipMY9263ExtendPropertyBase = void 0;
const t = __importStar(require("io-ts"));
const common = __importStar(require("../lib/common"));
const ChipBaseExtendPropey_1 = require("./ChipBaseExtendPropey");
exports.ChipMY9263ExtendPropertyBase = t.intersection([
    ChipBaseExtendPropey_1.ChipBaseExtendPropey,
    t.type({
        EnResetAPDMOrPWM: common.Bool_true,
        EnManualSyc: common.Bool_true,
    }),
    t.partial({
        ModeSelecte: common.Bool,
        PowerSavingMode: common.Bool,
        GclkMonitor: common.Bool,
        GclkPrivider: common.Bool,
        EnAutoCloseChannel: common.Bool,
 ...
 */
exports.ChipMY9263ExtendProperty = t.intersection([
    exports.ChipMY9263ExtendPropertyBase,
    t.partial({ '@_xsi:type': t.literal('ChipMY9263ExtendProperty') }),
], 'ChipMY9263ExtendProperty');
//# sourceMappingURL=ChipMY9263ExtendProperty.js.map