...
/**
 * @category Codecs
 * @desc Codec for interface {@link BrightModeMappingItem}
 * @see Automatically generated from ../decompiled/Nova.LCT.GigabitSystem.DataClass.decompiled.cs:59394
 */
export declare const BrightModeMappingItem: t.PartialC<{
    ...
    FileName: t.StringC;
    BrightPercent: t.Type<number, number, unknown>;
    BrightName: t.StringC;
    ...
    RedGainPercent: t.Type<number, number, unknown>;
    GreenGainPercent: t.Type<number, number, unknown>;
    BlueGainPercent: t.Type<number, number, unknown>;
    VRedGainPercent: t.Type<number, number, unknown>;
