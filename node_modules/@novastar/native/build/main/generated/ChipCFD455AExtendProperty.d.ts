...
export declare const ChipCFD455AExtendPropertyBase: t.IntersectionC<[t.PartialC<{}>, t.PartialC<{
...
/**
 * @category Codecs
 * @desc Codec for {@link ChipCFD455AExtendProperty}
 * @see Automatically generated from ../decompiled/Nova.LCT.GigabitSystem.ChipCFD455A.decompiled.cs:3371
 */
export declare const ChipCFD455AExtendProperty: t.IntersectionC<[t.IntersectionC<[t.PartialC<{}>, t.PartialC<{
    IsUseNewModule: t.Type<boolean, boolean, unknown>;
    ChipLibVersion: t.Type<number, number, unknown>;
    FirstRegValue: t.Type<number, number, unknown>;
    SecondRegValue: t.Type<number, number, unknown>;
