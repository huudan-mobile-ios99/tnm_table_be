...
/**
 * @category Codecs
 * @desc Codec for interface {@link SystemParameterConfig}
 * @see Automatically generated from ../decompiled/Nova.GigabitController.ProgramInnerData.decompiled.cs:905
 */
export declare const SystemParameterConfig: t.IntersectionC<[t.TypeC<{
    ReduInfoList: t.ArrayC<t.PartialC<{
        MasterSenderIndex: t.Type<number, number, unknown>;
        MasterPortIndex: t.Type<number, number, unknown>;
        SlaveSenderIndex: t.Type<number, number, unknown>;
        SlavePortIndex: t.Type<number, number, unknown>;
    }>>;
    CaptureScreenFrame: t.Type<number, number, unknown>;
}>, t.PartialC<{
    SacnBdProp: t.IntersectionC<[t.TypeC<{
    ...
    ScreenCfgInfo: common.BufferFromBase64;
    SyncVideoData: common.BufferFromBase64;
}>]>;
