...
import { CabinetTypeEnum } from './CabinetType';
import { LEDModuleProperty } from './LEDModuleProperty';
import { ModuleCascadeDiretionEnum } from './ModuleCascadeDiretion';
/**
 * @category Codecs
 * @desc Codec for interface {@link RegularCabinetProperty}
 * @see Automatically generated from ../decompiled/Nova.LCT.GigabitSystem.DataClass.decompiled.cs:23989
 */
export declare const RegularCabinetProperty: t.IntersectionC<[t.TypeC<{
    Name: t.StringC;
    ...
    CabinetType: t.Type<CabinetTypeEnum, "Unknown" | "Regular" | "IrRegular", unknown>;
    Width: t.Type<number, number, unknown>;
    Height: t.Type<number, number, unknown>;
    PointTableData: common.BufferFromBase64;
    ModColsInCabinet: t.Type<number, number, unknown>;
    ModRowsInCabinet: t.Type<number, number, unknown>;
