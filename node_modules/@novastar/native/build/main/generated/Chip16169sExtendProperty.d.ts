...
export declare const Chip16169sExtendPropertyBase: t.IntersectionC<[t.PartialC<{}>, t.TypeC<{
 ...
 */
export declare const Chip16169sExtendProperty: t.IntersectionC<[t.IntersectionC<[t.PartialC<{}>, t.TypeC<{
    FailureLEDEliminationGainLevel: t.Type<number, number, unknown>;
}>, t.PartialC<{
    GrayHorizontalStripesEliminateLow: t.Type<boolean, boolean, unknown>;
    LowGayCompensation: t.Type<number, number, unknown>;
