...
exports.ChipICN2065ExtendProperty = exports.ChipICN2065ExtendPropertyBase = void 0;
...
exports.ChipICN2065ExtendPropertyBase = t.intersection([
    ChipBaseExtendPropey_1.ChipBaseExtendPropey,
    t.type({
        ScanType: common.withDefault(ScanType_1.ScanType, 'Scan_32'),
        ...
        DclkNumPerScanRegPart: common.withDefault(common.Int32, 77),
        ...
        TwentyRegValue: common.withDefault(common.UInt16, 4864),
 ...
 */
exports.ChipICN2065ExtendProperty = t.intersection([
    exports.ChipICN2065ExtendPropertyBase,
    t.partial({ '@_xsi:type': t.literal('ChipICN2065ExtendProperty') }),
], 'ChipICN2065ExtendProperty');
//# sourceMappingURL=ChipICN2065ExtendProperty.js.map