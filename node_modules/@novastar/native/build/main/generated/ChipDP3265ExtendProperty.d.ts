...
export declare const ChipDP3265ExtendPropertyBase: t.IntersectionC<[t.PartialC<{}>, t.TypeC<{
 ...
 */
export declare const ChipDP3265ExtendProperty: t.IntersectionC<[t.IntersectionC<[t.PartialC<{}>, t.TypeC<{
    RegisterArray: t.ArrayC<t.Type<number, number, unknown>>;
}>, t.PartialC<{
    IsUseNewModule: t.Type<boolean, boolean, unknown>;
    ChipLibVersion: t.Type<number, number, unknown>;
